...
import com.micrantha.eyespie.core.data.account.model.CurrentSession.userId
...
class ObservabilityDataRepository(
    ...
    override suspend fun setUserProperties(properties: Map<String, Any>) {
        ...
        logger.debug("Set user properties for: $userId")
    }
    ...
    private suspend fun enrichEvent(event: TelemetryEvent): TelemetryEvent {
        ...
        // Add context
        userId?.let { enrichedProperties["userId"] = it }
        CurrentSession.sessionId?.let { enrichedProperties["sessionId"] = it }
