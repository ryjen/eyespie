...
kotlin {
    ...
    sourceSets {
        ...
        iosMain {
            kotlin.exclude("com/micrantha/eyespie/platform/scan/CameraAnalyzer.kt")
            kotlin.exclude("com/micrantha/eyespie/platform/scan/analyzer/**")
            kotlin.exclude("com/micrantha/eyespie/platform/scan/generator/**")
            dependencies {
