...
internal class SqlThingsLocalSource(
    ...
    override fun getAll(): Result<List<ThingAuthorityData>> = try {
        val things =
    ...
    override fun saveAll(things: List<ThingAuthorityData>): Result<Unit> = try {
        queries.transaction {
            things.forEach { thing ->
                val imagePath = thing.imagePath
