...
2. **[DEVELOPMENT.md](DEVELOPMENT.md)** — Build system, debugging, and tools
...
- [Issues](https://github.com/hackelia-micrantha/eyespie/issues) — Bug reports and features
- [Discussions](https://github.com/hackelia-micrantha/eyespie/discussions) — Community Q&A
...
- **Screenshots**: Add visuals for UI documentation
...
- **Missing docs**: Open an issue with "documentation" label
- **Incorrect info**: Submit a PR with correction
- **Unclear content**: Create discussion for clarification
